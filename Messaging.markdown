# My Messaging Resources - James Lavin

(Extracted from My Tech Resources due to Github README.markdown length limit & truncation)

## DESCRIPTION

Links to messaging (message queues, streams, brokers, etc) resources I have found useful or think might be helpful to future me or developers like me.

Related: [Event Sourcing, CQRS, DDD, & Microservices](https://github.com/JamesLavin/my_tech_resources/blob/master/EventSourcing.markdown)
...
##### MESSAGING - KAFKA - KAFKA STREAMS - KSQL
...
#### MESSAGING - KAFKA - PRODUCTIONIZING
...
#### MESSAGING - KAFKA - PRODUCTIONIZING - CONFLUENT + GOOGLE CLOUD
...
#### MESSAGING - KAFKA - PRODUCTIONIZING - STRIMZI
...
#### MESSAGING - KAFKA - LOG PERSISTENCE
...
* [Apache Pulsar: The Next Generation Messaging and Queuing System - Karthik Ramasamy (YOW! Data 2020)](https://www.youtube.com/watch?v=30QKArypisg)
* [Ten reasons to choose Apache Pulsar over Apache Kafka for Event Sourcing (CQRS) — Robert van Mölken (StreamNative 2020)](https://www.youtube.com/watch?v=RS0vEgqAnI4)
